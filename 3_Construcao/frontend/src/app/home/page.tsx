  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-amber-50/30">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-br from-amber-600 via-orange-600 to-amber-800" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
                ...
                <span className="block text-amber-200">ISPTEC</span>
              </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="border-0 bg-linear-to-br from-blue-50 to-amber-50 shadow-sm">
          ...
          <Card className="border-0 bg-linear-to-br from-orange-50 to-pink-50 shadow-sm sm:col-span-2 lg:col-span-1">
            <CardContent className="p-6">
